...
> 基于 ts-refactor 工作流（valaxy 基准映射到 BE 外置组件场景）。分支 `refactor/v0.0.8.x`，目标版本 v0.0.8。
...
| 8 | `chore(version)` | 按用户指定 bump 到 v0.0.8：package.json + CHANGELOG + 重建 dist + annotated tag |
